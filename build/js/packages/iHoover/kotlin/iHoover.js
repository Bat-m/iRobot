(function (root, factory) {
  ...
  function PositiveNumber(value) {
    this.value = value;
    if (!(this.value >= 0)) {
      var message = 'La valeur doit \xEAtre positive';
      throw IllegalArgumentException_init(message.toString());
    }}
  PositiveNumber.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'PositiveNumber',
    interfaces: []
  };
  PositiveNumber.prototype.component1 = function () {
    return this.value;
  };
  PositiveNumber.prototype.copy_za3lpa$ = function (value) {
    return new PositiveNumber(value === void 0 ? this.value : value);
  };
  PositiveNumber.prototype.toString = function () {
    return 'PositiveNumber(value=' + Kotlin.toString(this.value) + ')';
  };
  PositiveNumber.prototype.hashCode = function () {
    var result = 0;
    result = result * 31 + Kotlin.hashCode(this.value) | 0;
    return result;
  };
  PositiveNumber.prototype.equals = function (other) {
  ...
  CoordsProps.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'CoordsProps',
    interfaces: []
  };
  ...
  CurrentCoordsProps.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'CurrentCoordsProps',
    interfaces: []
  };
  ...
  function IHooverProps() {
  }
  IHooverProps.$metadata$ = {
    kind: Kind_INTERFACE,
    simpleName: 'IHooverProps',
    interfaces: []
  };
  function Coroutine$repeatFun$lambda($receiver_0, controller, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.$controller = controller;
    this.exceptionState_0 = 1;
    this.local$$receiver = $receiver_0;
  }
  Coroutine$repeatFun$lambda.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$repeatFun$lambda.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$repeatFun$lambda.prototype.constructor = Coroutine$repeatFun$lambda;
  Coroutine$repeatFun$lambda.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
  ...
  function repeatFun$lambda($receiver_0, continuation_0, suspended) {
    var instance = new Coroutine$repeatFun$lambda($receiver_0, this, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  }
  function Coroutine$repeatFun(continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
  }
  Coroutine$repeatFun.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$repeatFun.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$repeatFun.prototype.constructor = Coroutine$repeatFun;
  Coroutine$repeatFun.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = coroutineScope(repeatFun$lambda, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  function repeatFun(continuation_0, suspended) {
    var instance = new Coroutine$repeatFun(continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  ...
  IHooverState.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'IHooverState',
    interfaces: []
  };
  ...
  Coroutine$IHoover$render$lambda$lambda$lambda$lambda$lambda.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  ...
  Coroutine$IHoover$render$lambda$lambda$lambda$lambda.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
